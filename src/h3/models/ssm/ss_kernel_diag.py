...
from h3.ops.vandermonde import log_vandermonde_fast
try:
    import pykeops
    from h3.ops.vandermonde import log_vandermonde, log_vandermonde_transpose
    has_pykeops = True
    log.info("Pykeops installation found.")
except ImportError:
    has_pykeops = False
    from h3.ops.vandermonde import log_vandermonde_naive as log_vandermonde
    from h3.ops.vandermonde import log_vandermonde_transpose_naive as log_vandermonde_transpose
    log.warning(
